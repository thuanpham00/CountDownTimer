window.addEventListener("load", function () {
    ...
    `;
        ...
        [...itemMusicView].forEach(item => item.addEventListener("click", function(e) {
            const pathMusic = e.target.querySelector("#song")
            const pathMusic2 = pathMusic.getAttribute("dataset-value")
            console.log(pathMusic2)
