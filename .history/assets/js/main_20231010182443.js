window.addEventListener("load", function () {
    ...
    function MusicPlayer() {
        ...
        this.listMusicRender = {
            ...
            render: function () {
                const song = this.songs[MusicPlayer.currentSongIndex];
                const htmls = `<div class="song" data-index="${this.currentSongIndex}">
                        <h2>${song.name}</h2>
                        <p>${song.singer}</p>
                ...
                `;
                MusicPlayer.container.innerHTML = htmls;
            },
        };
        ...
        this.btnPlay.addEventListener("click", () => this.playMusic());
        this.listMusicRender.render();

        this.btnNext.addEventListener("click", () => this.handleChangeMusic(1));

        this.btnPrev.addEventListener("click", () => this.handleChangeMusic(-1));
