window.addEventListener("load", function () {
    function time() {
        ...
        const this.hoursText = document.querySelector("#hours");
        const this.minutesText = document.querySelector("#minutes");
        const this.secondsText = document.querySelector("#seconds");
    }
