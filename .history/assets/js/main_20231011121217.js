window.addEventListener("load", function () {
    ...
    MusicMp3.prototype.playSelectedSong = function (songIndex) {
        ...
        this.audio.src = songs[currentSongIndex].path;
        this.audio.play();
        this.playing = true;
        this.btnPlay.classList.remove("fa-play");
        this.btnPlay.classList.add("fa-pause");
    ...
    const timer = setInterval(this.checkTimer.bind(this), 1000); // chạy hàm sau mỗi lần 1s để nó reset tăng lên thời gian hiện tại (currentTime)
