window.addEventListener("load", function () {
    ...
    function MusicMp3() {
        ...
        this.img = document.querySelector(".imgPlayerBox");
    }
    new MusicMp3();
    ...
    `;
        ...
        [...itemMusicView].forEach((item) =>
            item.addEventListener("click", function (e) {
                ...
                const imgMusicBox = document.querySelector(".imgPlayerBox");
                imgMusicBox.classList.add("is-playing")
