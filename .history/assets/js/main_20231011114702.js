window.addEventListener("load", function () {
    ...
    function MusicMp3() {
        ...
        this.listMusicRender = {
            ...
            //     console.log(song)
            //     const htmls = `<div class="song" data-index="${MusicMp3.currentSongIndex}">
            //             <h2>${song.name}</h2>
            //             <p>${song.singer}</p>
            ...
            //         </div>
            //     `;
            //     MusicMp3.container.innerHTML = htmls;
            // },
            render: function () {
                // Xóa tất cả các bài hát hiện có
                MusicMp3.container.innerHTML = '';
    
                // Lặp qua danh sách bài hát và hiển thị chúng
                this.songs.forEach((song, index) => {
                    ...
                    songElement.appendChild(singer);
    ...
    new MusicMp3();
    MusicMp3.prototype.playMusic = function (e) {
        if (this.playing) {
            this.playing = false;
