window.addEventListener("load", function () {
    ...
    function MusicMp3() {
        ...
        this.itemMusic.forEach(item => item.addEventListener("click", console.log(item))))
    }
    new MusicMp3();
    ...
    MusicMp3.prototype.printListMusic = function () {
        const that2 = this;
        that2.listMusicRender.songs.forEach((item) => {
            const itemMusic = `<div class="song song-row itemMusic" data-index="${that2.item}">
