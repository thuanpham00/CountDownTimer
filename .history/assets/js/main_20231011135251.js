window.addEventListener("load", function () {
    ...
    MusicMp3.prototype.randomMusic = function () {
        const random = this.listMusicRender.songs[(Math.floor(this.listMusicRender.songs.length *  Math.random()))].path;
        this.listMusicRender.render();
        this.audio.src = this.listMusicRender.songs[random].path
        this.audio.play();
        this.playing = true;
        this.btnPlay.classList.remove("fa-play");
        this.btnPlay.classList.add("fa-pause");
