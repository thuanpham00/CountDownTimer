window.addEventListener("load", function () {
    ...
    function setTimer(dateInput, monthInput, dayInput, yearInput, hourInput, gmtInput) {
    ...
    formTimer.addEventListener("submit", function (e) {
        ...
        console.log(dateInput, monthInput, dayInput, yearInput, hourInput, gmtInput)
        setTimer(dateInput, monthInput,dayInput, yearInput, hourInput, gmtInput);
    });
});
