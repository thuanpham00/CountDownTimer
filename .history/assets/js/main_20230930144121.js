...
//             // Xây dựng HTML cho từng bài hát ở đây
//             // Ví dụ:
//             return `
//                     <div class="song">
//                         <h2>${song.name}</h2>
...
//         // Sau khi đã xây dựng HTML cho tất cả bài hát, bạn có thể kết hợp chúng thành một chuỗi HTML hoặc sử dụng DOM để hiển thị lên trang web.
//         const songsContainer = document.querySelector(".songs-container");
//         songsContainer.innerHTML = htmls.join("");
//     },
// };
// listMusicRender.render();
...
const songs = [
    {
        ...
        artist: "Artist 1",
        audioSrc: "song1.mp3",
        albumArtSrc: "song1.jpg",
    },
    {
        title: "Song 2",
        artist: "Artist 2",
        audioSrc: "song2.mp3",
        albumArtSrc: "song2.jpg",
    },
    {
        title: "Song 3",
        artist: "Artist 3",
        audioSrc: "song3.mp3",
        albumArtSrc: "song3.jpg",
    },
];
...
function loadSong(index) {
    ...
    albumArt.src = songs[index].albumArtSrc;
}
