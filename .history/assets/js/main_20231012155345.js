window.addEventListener("load", function () {
    ...
    function MusicMp3() {
        ...
        this.listMusic = document.querySelector(".player-list")
    ...
    MusicMp3.prototype.randomMusic = function () {
        ...
        const random = Math.floor(this.listMusicRender.songs.length * Math.random())
    ...
    MusicMp3.prototype.printListMusic = function() {
        const that2 = this;
        this.listMusicRender.songs.map(item =>  {
            const itemMusic =  `<div class="song" data-index="${self.currentSongIndex}">
            <h2 class="nameSong">${song.name}</h2>
            <p>${song.singer}</p>
            <img src="${song.img}" alt="${song.name}" class="img" />
            <audio src="${song.path}" controls id="song" style="display: none"></audio>
    ...
    `;
            that2.listMusic.append(itemMusic)
