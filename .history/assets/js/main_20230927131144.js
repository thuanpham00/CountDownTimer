window.addEventListener("load", function () {
    ...
    formTimer.addEventListener("submit", function(e) {
        ...
        const monthInput = this.elements["date"].value;
        const yearInput = this.elements["date"].value;
        const dayInput = this.elements["date"].value;
        const hourInput = this.elements["date"].value;
