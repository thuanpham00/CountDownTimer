window.addEventListener("load", function () {
    ...
    MusicMp3.prototype.playMusic = function () {
        this.audio.setAttribute("src",`${this.listMusicRender.songs[this.currentSongIndex].path}`)
        if (this.playing) {
            this.playing = false;
    ...
    MusicMp3.prototype.handleChangeMusic = function (dir) {
        if (dir === 1) {
            ...
            console.log(this.playSelectedSong(this.currentSongIndex))
        } else if (dir === -1) {
            this.currentSongIndex--;
    ...
    MusicMp3.prototype.playSelectedSong = function (songIndex) {
        ...
        this.audio.src = this.songs[this.currentSongIndex].path;
        this.audio.play();
        this.playing = true;
        this.btnPlay.classList.remove("fa-play");
        this.btnPlay.classList.add("fa-pause");
