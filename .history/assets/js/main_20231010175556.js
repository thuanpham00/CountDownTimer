window.addEventListener("load", function () {
    ...
    function MusicPlayer() {
        ...
        const this.btnPlay = document.querySelector(".player-play");
        const this.btnNext = document.querySelector(".player-next");
        const this.btnPrev = document.querySelector(".player-prev");
        const this.bar = document.querySelector(".bar");
        const this.currentTimeText = document.querySelector(".player-remaining");
        const this.durationTimeText = document.querySelector(".player-duration");
        const this.audio = document.querySelector("#song");
    }
