window.addEventListener("load", function () {
    ...
    function MusicMp3() {
        ...
        // this.itemMusic = document.querySelectorAll(".itemMusic");
        // this.itemMusic.forEach((item) => {
        //     console.log(item);
        // });
    }
    new MusicMp3();
    ...
    const itemMusic = document.querySelectorAll(".itemMusic");
    [...itemMusic].forEach((item,index) => {
        console.log(item);
    });
});
