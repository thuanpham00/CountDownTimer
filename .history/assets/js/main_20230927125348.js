    ...
    function setTimer(date) {
        ...
        function changeTimer() {
            ...
            if(countDown > 0) {
                ...
                daysText.textContent = `${days}`.splice(-2)
                hoursText.textContent = `${hours}`.splice(-2)
                minutesText.textContent = `${minutes}`.splice(-2)
                secondsText.textContent = `${seconds}`.splice(-2)
            }
        }
    }
